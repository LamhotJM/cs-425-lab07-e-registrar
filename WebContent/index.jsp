...
<head>
    ...
    <title>eRegistrar - a demo Spring MVC Framework</title>
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <a style="padding-right: 2em;" class="navbar-brand" href="/elibrary/home">eRegistrar : : : a basic demo webapp using Spring MVC Framework</a>
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item" style="border-left: white 1px solid; padding-left: 2em; padding-right: 2em;">
                    <a class="nav-link" href="/elibrary/book/list">Browse Courses Schedule</a>
                </li>
            </ul>
    ...
    <p>&nbsp;</p>
    <div class="container">
        <h3>Welcome to the eRegistrar System(eRegSys)</h3>
        <hr/>
